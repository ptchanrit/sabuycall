    ...
    return (
        <div className="flex flex-col items-center mt-4 px-2">
            <div className=" relative bg-transparent flex flex-col items-center justify-center rounded-lg w-32 h-32  text-2xl md:text-4xl mt-4 ">
                <div className="rounded-t-lg rounded-b-lg bg-[#06b6d4] w-full h-full"></div>

                <div className="text-5xl absolute text-sky-700 z-10 font-bold font-redhat md:text-7xl font-mono ">
                    {num}
                </div>

                <div className=" rounded-b-lg rounded-t-lg bg-[#e0f2fe] w-full h-full"></div>
            ...
            <p className="text-lg mt-3 font-semibold text-sky-100 font-redhat  md:text-2xl ">
                {unit}
            </p>
        </div>
    )
